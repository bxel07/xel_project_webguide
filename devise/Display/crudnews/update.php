...
<body>
    <div class="container">
        <h3 class="text-center fw-bold ">Edit News Update</h3>
    <div class="row justify-content-center">
        <div class="col-md-6">
        <form method="post" action="/news/up">
            <div class="mb-3">
                <input type="hidden" name="id" value="<?= $model[0]['id'];?>">
            <label for="inputText" class="form-label">Title</label>
            <input type="text" name="title" class="form-control" id="inputText" value="<?= $model[0]['title'];?>">
            </div>
            <div class="mb-3">
            <label for="textarea" class="form-label">Content</label>
            <textarea name="content" class="form-control" id="textarea" rows="5" placeholder="<?= $model[0]['content'];?>"></textarea>
            </div>
